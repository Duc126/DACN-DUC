            ...
            <div class="header-left" style="height:70px;">
                <a href="<?php echo e(url('/')); ?>" class="bravo-logo">
                    <?php if($logo_id = setting_item("logo_id")): ?>
                        ...
                        <img src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item("site_title")); ?>" style="width: 211px";>
                    <?php endif; ?>
                </a>
...
</div><?php /**PATH /home/mtcv/.local/share/Trash/files/DACN_LV/resources/views/layouts/parts/header.blade.php ENDPATH**/ ?>