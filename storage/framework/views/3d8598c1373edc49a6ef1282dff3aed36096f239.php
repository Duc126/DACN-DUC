                ...
                <?php if(!empty($rows)): ?>
                    <form method="post" action="<?php echo e(url('admin/module/tour/bulkEdit')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
                        ...
                        <select name="action" class="form-control">
                            <option value=""><?php echo e(__(" Select Actions ")); ?></option>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mtcv/.local/share/Trash/files/DACN_LV/modules/Tour/Views/admin/index.blade.php ENDPATH**/ ?>