<div class="bravo-form-search-tour" style="background-image: url('<?php echo e($bg_image_url); ?>') !important;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="text-heading text-center" style="color: cornsilk;"><?php echo e($title); ?></h1>
...
</div><?php /**PATH /home/mtcv/.local/share/Trash/files/DACN_LV/modules/Tour/Views/frontend/blocks/form-search-tour/index.blade.php ENDPATH**/ ?>