				...
				<div class="offset-md-2 col-md-5">
					<div class="contact-info">
						...
						<div class="info-content">
							<h3><?php echo e(__('Đức Bùi')); ?></h3>
							<div class="sub">
								<p></p>
								<p><?php echo e(__('Tell. + 0355913199')); ?></p>
								<p><?php echo e(__('Email. ducbui1211@gmail.com')); ?></p>
								<p class="address"><?php echo e(__('Lê Duẩn, TP.Vinh, Nghê An, Việt Nam')); ?> </p>
							</div>
						</div>
					</div>
				</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/DACN_LV/modules/Contact/Views/index.blade.php ENDPATH**/ ?>